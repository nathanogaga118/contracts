...
library BorrowingFeesUtils {
    ...
    function getTradeBorrowingFee(
        ...
        IBorrowingFees.BorrowingPairGroup[] memory pairGroups = _getStorage().pairGroups[
            _input.collateralIndex
        ][_input.pairIndex];
    ...
    function getPairOisCollateral(
        ...
        IBorrowingFees.OpenInterest storage pairOi = _getStorage().pairOis[_collateralIndex][
            _pairIndex
        ];
    ...
    function getPairOiCollateral(
        ...
        (uint256 longOiCollateral, uint256 shortOiCollateral) = getPairOisCollateral(
            _collateralIndex,
            _pairIndex
        );
    ...
    function _setBorrowingPairParams(
        ...
        if (_value.groupIndex != prevGroupIndex) {
            ...
            IBorrowingFees.BorrowingData memory newGroup = s.groups[_collateralIndex][
                _value.groupIndex
            ];
            IBorrowingFees.BorrowingData memory prevGroup = s.groups[_collateralIndex][
                prevGroupIndex
            ];
    ...
    function _setPairPendingAccFees(
        ...
        IBorrowingFees.BorrowingData storage pair = _getStorage().pairs[_collateralIndex][
            _pairIndex
        ];
    ...
    function _setGroupPendingAccFees(
        ...
        IBorrowingFees.BorrowingData storage group = _getStorage().groups[_collateralIndex][
            _groupIndex
        ];
