...
contract StateRelayer is IStateRelayer {
     ...
     */
    function updateVaultGeneralInformation(VaultGeneralInformation calldata _vaultInfo) external {
    ...
    */
     ...
     */
    function batchCallByBot(bytes[] calldata funcCalls) external {
